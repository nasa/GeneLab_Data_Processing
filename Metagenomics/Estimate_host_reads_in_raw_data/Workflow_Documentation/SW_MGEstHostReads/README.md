...
* `--use-conda` – specifies to use the conda environments included in the workflow (these are specified in the [envs](workflow_code/SW_MGEstHostReads_1.0.0/envs) directory)
