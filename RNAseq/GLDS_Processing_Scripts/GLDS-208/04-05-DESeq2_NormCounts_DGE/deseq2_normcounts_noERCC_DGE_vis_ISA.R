...
metadata_dir="/path/to/GLDS-208/Metadata"
work_dir="/path/to/GLDS-208/processing_scripts/04-05-DESeq2_NormCounts_DGE"
counts_dir="/path/to/GLDS-208/03-RSEM_Counts"
norm_output="/path/to/GLDS-208/04-DESeq2_NormCounts"
DGE_output="/path/to/GLDS-208/05-DESeq2_DGE"
