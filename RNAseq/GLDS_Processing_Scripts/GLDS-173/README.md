# GeneLab processing commands for GLDS-173
This dataset was processed with [GL-DPPD-7101-A](../../Pipeline_GL-DPPD-7101_Versions/GL-DPPD-7101-A.md).

The raw and processed data are available from: [https://genelab-data.ndc.nasa.gov/genelab/accession/GLDS-173/](https://genelab-data.ndc.nasa.gov/genelab/accession/GLDS-173/)
