...
work_dir="/path/to/GLDS-173/processing_scripts/04-05-DESeq2_NormCounts_DGE"
counts_dir="/path/to/GLDS-173/03-RSEM_Counts"
norm_output="/path/to/GLDS-173/04-DESeq2_NormCounts"
DGE_output="/path/to/GLDS-173/05-DESeq2_DGE"
DGE_output_ERCC="/path/to/GLDS-173/05-DESeq2_DGE/ERCC_NormDGE"
