...
metadata_dir="/GLDS-120/Metadata"
work_dir="/GLDS-120/processing_scripts/04-05-DESeq2_NormCounts_DGE_wSTAT" ## Must contain organisms.csv file
counts_dir="/GLDS-120/03-RSEM_Counts_none"
norm_output="/GLDS-120/04-DESeq2_NormCounts_none"
DGE_output="/GLDS-120/05-DESeq2_DGE_none"
...
# If a metadata file is used instead of ISA, uncomment this line and comment the ISA lines above
...
keytype = "TAIR" # will be different if primary annotations are not ENSEMBL
