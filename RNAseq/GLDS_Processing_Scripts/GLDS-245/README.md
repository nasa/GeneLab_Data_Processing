# GeneLab processing commands for GLDS-245
This dataset was processed with [GL-DPPD-7101-C](../../Pipeline_GL-DPPD-7101_Versions/GL-DPPD-7101-C.md).

The raw and processed data are available from: [https://genelab-data.ndc.nasa.gov/genelab/accession/GLDS-245/](https://genelab-data.ndc.nasa.gov/genelab/accession/GLDS-245/)
...
|Cutadapt|2.8|[https://cutadapt.readthedocs.io/en/stable/](https://cutadapt.readthedocs.io/en/stable/)|
...
|STAR|2.7.1a (for generating the STAR index); 2.7.3a (for trimmed read alignment)|[https://github.com/alexdobin/STAR](https://github.com/alexdobin/STAR)|
