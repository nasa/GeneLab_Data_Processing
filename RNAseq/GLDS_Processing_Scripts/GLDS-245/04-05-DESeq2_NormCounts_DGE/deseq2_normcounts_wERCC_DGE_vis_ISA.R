...
metadata_dir="/path/to/GLDS-245/Metadata"
work_dir="/path/to/GLDS-245/processing_scripts/04-05-DESeq2_NormCounts_DGE"
counts_dir="/path/to/GLDS-245/03-RSEM_Counts"
norm_output="/path/to/GLDS-245/04-DESeq2_NormCounts"
DGE_output="/path/to/GLDS-245/05-DESeq2_DGE"
DGE_output_ERCC="/path/to/GLDS-245/05-DESeq2_DGE/ERCC_NormDGE"
...
### print ERCC raw counts table after filtering ERCC genes with counts less than 10
