...
* If using custom gene annotations when processing Affymetrix datasets through GeneLab's Affymetrix processing pipeline, a CSV design information file must be provided as specified below.
...
| create_date | date string | The date the file was created in YYYY-MM-DD format. | 2024-03-30 |
