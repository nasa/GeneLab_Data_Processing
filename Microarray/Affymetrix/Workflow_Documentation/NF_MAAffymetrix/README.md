# NF_MAAffymetrix Workflow Information and Usage Instructions <!-- omit in toc -->
...
<p align="center">
<a href="../../images/NF_MAAffymetrix_rnaseq_workflow.png"><img src="../../images/NF_MAAffymetrix_rnaseq_workflow.png"></a>
</p>
...
All files required for utilizing the NF_MAAffymetrix GeneLab workflow for processing RNASeq data are in the [workflow_code](workflow_code) directory. To get a 
...
To avoid this issue, run the following command to fetch the Singularity images prior to running the NF_MAAffymetrix workflow:
> Note: This command should be run in the location containing the `NF_MAAffymetrix_1.0.2` directory that was downloaded in [step 2](#2-download-the-workflow-files) above. Depending on your network speed, fetching the images will take ~20 minutes.  

```bash
bash NF_MAAffymetrix_1.0.2/bin/prepull_singularity.sh NF_MAAffymetrix_1.0.2/config/software/by_docker_image.config
```
