...
# If using custom annotation, local_annotation_dir is path to directory containing annotation file and config
local_annotation_dir <- params$local_annotation_dir # <path/to/custom_annotation>
