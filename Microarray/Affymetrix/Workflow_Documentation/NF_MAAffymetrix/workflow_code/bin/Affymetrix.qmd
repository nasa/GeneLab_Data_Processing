...
#| warning: false # NAN can be produced due to log transformations
# NON_DPPD: # TODO: This should be made dynamic
...
message(paste0("Number of Arrays: ", dim(featureset_level_data)[2])) # NON_DPPD
message(paste0("Total Number of Probesets: ", dim(oligo::getProbeInfo(featureset_level_data, target="core")['man_fsetid'])[1])) # NON_DPPD
message(paste0("Number of Featuresets: ", dim(unique(oligo::getProbeInfo(featureset_level_data, target="core")['man_fsetid']))[1])) # NON_DPPD
# NON_DPPD:START
#DT::datatable(raw_data$targets, caption = "Sample to File Mapping")
#DT::datatable(head(raw_data$genes, n = 20), caption = "First 20 rows of raw data file embedded probes to genes table")
# NON_DPPD:END
...
## Perform Featureset Differential Expression and Annotation
...
### Featureset Differential Expression (DE)

#### Add Featureset Annotations
