...
params:
  ...
  primary_keytype: NULL # str, Keytype to join annotation table and microarray probes, depends on organism
...
annotation_file_path <- params$annotation_file_path # Annotation file from 'genelab_annots_link' column of https://github.com/nasa/GeneLab_Data_Processing/blob/GL_RefAnnotTable_1.0.0/GeneLab_Reference_Annotations/Pipeline_GL-DPPD-7110_Versions/GL-DPPD-7110/GL-DPPD-7110_annotations.csv
primary_keytype <- params$primary_keytype # Keytype to join annotation table and microarray probes, depends on organism
message(params)
```
