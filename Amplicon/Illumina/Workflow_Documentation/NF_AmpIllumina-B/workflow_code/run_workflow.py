...
def create_config(target_region, raw_R1_suffix, raw_R2_suffix, trim_primers, input_file, min_cutadapt_len, primers_linked,
                  ...
                  container_dada, container_ancom, container_diversity, singularity_cacheDir):
...
params {{
    ...
    // Directories
    fastqc_out_dir      = "{output_dir}/FastQC_Outputs/"
    trimmed_reads_dir   = "{output_dir}/Trimmed_Sequence_Data/"
    filtered_reads_dir  = "{output_dir}/Filtered_Sequence_Data/"
    info_out_dir        = "{output_dir}/Metadata/"
    final_outputs_dir   = "{output_dir}/Final_Outputs/"
...
def main():
    ...
    parser.add_argument('--diff-abund-method',
                        choices=["ancombc1", "ancombc2", "deseq2"],
                        default="ancombc2",
