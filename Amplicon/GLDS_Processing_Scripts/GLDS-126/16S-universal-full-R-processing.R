...
raw_and_trimmed_read_counts <- read.table("../Trimmed_Reads/16S-universal-trimmed-read-counts.tsv", header=T, sep="\t")

    # reading in filtered read counts
filtered_read_counts <- read.table("../Filtered_Reads/16S-universal-filtered-read-counts.tsv", header=T, sep="\t")
